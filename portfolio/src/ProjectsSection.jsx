...
const PROJECTS = [
  {
    ...
    highlights: ["Requirement gathering dengan pemangku kepentingan","Perancangan database & alur sistem end-to-end","Integrasi RESTful API hanya dengan Disdukcapil Cimahi","Deployment hingga aktif di production","Maintenance & bug fixing pasca deployment"],
  ...
  },
  {
    ...
    highlights: ["Entity Relationship Diagram (ERD)","Normalisasi hingga 3NF","Indexing untuk query performance","Stored procedures & views","Audit trail & soft delete mechanism"],
