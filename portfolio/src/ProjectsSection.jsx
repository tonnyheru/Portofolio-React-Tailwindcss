...
const PROJECTS = [
  {
    ...
    score: "Nilai 90/100",
    description: "Sistem administrasi peradilan terintegrasi yang dibangun secara mandiri. Terhubung dengan layanan Disdukcapil Cimahi, Kab. Bandung, dan Bandung Barat via RESTful API untuk verifikasi data warga secara otomatis.",
    highlights: ["Requirement gathering dengan pemangku kepentingan","Perancangan database & alur sistem end-to-end","Integrasi 3 RESTful API Disdukcapil","Deployment hingga aktif di production","Maintenance & bug fixing pasca deployment"],
  ...
  },
  {
    ...
    images: [],
    link: "https://tonnyheru.github.io/Portofolio-React-Tailwindcss/",
  ...
  },
  {
    ...
    highlights: ["Konsumsi 3 endpoint API Disdukcapil berbeda","Validasi NIK & data kependudukan otomatis","Error handling & fallback mechanism","Response caching untuk performa optimal","Logging & monitoring request/response"],
